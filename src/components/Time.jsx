...
const date = new Date("25. September 2021. 11:00 GMT+0200");
                  ...
                  <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-lg mx-auto">
                      <dl className="grid grid-cols-4 bg-gray-800 border-2 border-gray-700 rounded-lg shadow-lg">
                        <div className="flex flex-col p-6 text-center border border-b border-r border-gray-700">
                        ...
                        <div className="flex flex-col p-6 text-center border-t border-b border-l border-r border-gray-700">
                        ...
                        <div className="flex flex-col p-6 text-center border-t border-l border-gray-700">
